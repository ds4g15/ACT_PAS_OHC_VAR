...
------------
NEMO FILES:
mesh_mask.nc file for ORCA2 (generated by switching nn_msh=1 in namelist of run)

IPSL FILES: (outputs from pre-industrial control run)
piCtrlDaily2_18500101_18691231_1D_SBC.nc
piCtrlDaily2_18500101_18691231_1D_histday.nc
piCtrlDaily2_18500101_18691231_1D_grid_U.nc
piCtrlDaily2_18500101_18691231_1D_grid_V.nc


OUTPUT:
--------
Saves arrays of each location and its e-folding time (in seconds):

   flux_e_folding_time_T.npy
   flux_e_folding_time_S.npy
   flux_e_folding_time_U.npy
   flux_e_folding_time_V.npy
   
'''

load_grid=1 # Load necessary ORCA2 grid variables (as in 1_calc_Sigma_ext.py)
load_IPSL=0 # Load outputs from IPSL model (as in 1_calc_Sigma_ext.py)
...
if calc_time:
    ...
    ti=np.linspace(0,365*86400,3650);
...
if save_npy:
    np.save('flux_e_folding_time_SST.npy' ,decor_time_SST) #e-folding time (s)
    np.save('flux_e_folding_time_SSS.npy',decor_time_SSS)
    np.save('flux_e_folding_time_SSU.npy',decor_time_SSU)
    np.save('flux_e_folding_time_SSV.npy',decor_time_SSV)    
