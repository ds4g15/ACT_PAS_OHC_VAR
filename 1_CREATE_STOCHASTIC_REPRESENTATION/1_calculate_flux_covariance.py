...
Sparse arrays of shape (27118,27118):
   flux_cov_SST_SST.npz [Units K^2/s^2]
   flux_cov_SSS_SSS.npz [Units psu^2/s^2]
   flux_cov_SST_SSS.npz [Units (K psu)/s^2]

   flux_cov_SSU_SSU.npz [Units m^2/s^4]
   flux_cov_SSV_SSV.npz [Units m^2/s^4]
   flux_cov_SSU_SSV.npz [Units m^2/s^4]
'''
################################################################################
### OPTIONS##
...
if save_npzf:
    ...
    print('Heat flux')
    sp.save_npz('flux_cov_SST_SST',COV_TT_sp)
    print('Salt flux')
    sp.save_npz('flux_cov_SSS_SSS',COV_SS_sp)
    print('Covariance')
    sp.save_npz('flux_cov_SST_SSS',COV_TS_sp)    

    print('Zonal momentum flux')
    sp.save_npz('flux_cov_SSU_SSU',COV_UU_sp)
    print('Meridional momentum flux')
    sp.save_npz('flux_cov_SSU_SSV',COV_UV_sp)
    print('Covariance')
    sp.save_npz('flux_cov_SSV_SSV',COV_VV_sp)    
